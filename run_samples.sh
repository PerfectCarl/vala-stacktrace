...
# Null reference
valac -g -X -rdynamic --pkg linux --pkg gee-0.8 -o ./samples/sample_sigsegv ./samples/vala_file.vala ./samples/error_sigsegv.vala ./src/Stacktrace.vala ./samples/module/OtherModule.vala
...
valac -g -X -rdynamic --pkg linux --pkg gee-0.8 -o ./samples/sample_colors ./samples/error_colors.vala ./src/Stacktrace.vala
